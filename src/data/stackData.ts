...
export const stackData: StackSection[] = [
  ...
  // IDEs & AGENTES DE CODIFICAÇÃO COM IA
  {
    cat: "IDEs & Agentes de IA",
    icon: "🧠",
    items: [
      {
        name: "Cursor",
        desc: "IDE AI-native baseada no VS Code com compreensão profunda de codebase, edição multi-arquivo e Background Agents. Padrão de mercado para devs power users em 2026.",
        example: "Vercel, Perplexity",
        isNew: false,
        link: "https://cursor.com",
      },
      {
        name: "Windsurf",
        desc: "IDE agentic da Codeium com Cascade totalmente autônomo. Melhor custo-benefício do mercado com tier gratuito generoso e fluxo de trabalho fluido.",
        example: "Startups globais",
        isNew: false,
        link: "https://windsurf.com",
      },
      {
        name: "Claude Code",
        desc: "Agente de terminal da Anthropic com raciocínio superior para debug, refatoração e execução autônoma em codebases complexas. Provider-agnostic via API.",
        example: "Times de engenharia",
        isNew: true,
      ...
      {
        name: "Kiro",
        desc: "IDE da AWS focada em desenvolvimento spec-driven. Gera specs, tasks e implementa features de forma estruturada com suporte a MCP e hooks de automação.",
        example: "AWS, times enterprise",
        isNew: true,
        link: "https://kiro.dev",
      },
      {
        name: "GitHub Copilot",
        desc: "Assistente de IA integrado ao ecossistema GitHub com Agent Mode, sugestões inline e chat. Opção mais segura para times enterprise com compliance.",
        example: "Microsoft, Shopify",
        isNew: false,
        link: "https://github.com/features/copilot",
      },
      {
        name: "Google Antigravity",
        desc: "IDE agentic do Google com orquestração multi-agente nativa e Gemini Ultra integrado. Lançada em 2026 com foco em projetos de grande escala.",
      ...
      {
        name: "OpenAI Codex",
        desc: "Agente cloud da OpenAI com app desktop próprio. Executa tarefas de forma assíncrona em ambientes isolados, ideal para automação de features completas.",
      ...
      {
        name: "OpenCode",
        desc: "Agente de codificação open-source para o terminal, criado pelo time do SST. Alternativa leve e extensível ao Claude Code, com suporte a múltiplos providers.",
        example: "SST, open-source devs",
        isNew: true,
      ...
      {
        name: "Aider",
        desc: "Agente de terminal open-source com integração nativa ao Git. Edita múltiplos arquivos, faz commits automáticos e suporta todos os principais LLMs.",
      ...
      {
        name: "Cline (Roo Code)",
        desc: "Extensão VS Code open-source com capacidades agentic completas: executa comandos, edita arquivos e navega na web. Fork Roo Code adiciona modos especializados.",
        example: "VS Code community",
        isNew: true,
      ...
      {
        name: "Tabnine",
        desc: "Assistente de IA com foco em privacidade e compliance enterprise. Suporta deploy on-premises e treinamento em código proprietário sem enviar dados para fora.",
        example: "Samsung, Lockheed Martin",
        isNew: false,
        link: "https://tabnine.com",
      },
      {
        name: "Goose",
        desc: "Agente de codificação open-source da Block (Square). Extensível via plugins, roda localmente e suporta múltiplos LLMs com foco em autonomia real.",
        example: "Block, open-source",
        isNew: true,
